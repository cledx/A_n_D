class Story < ApplicationRecord
  ...
  def generate_system_prompt
      <<-PROMPT
        ...
        Narrate the user through the adventure, presenting them with challenges along the way. Do not be afraid to damage them. Whenever they would do an action that would hurt them, make them take damage.
      ...
      # Dice Roll Prompting, To Be Implemented
